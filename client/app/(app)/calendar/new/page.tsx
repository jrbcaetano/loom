...
export default async function NewEventPage() {
  ...
  return (
    <section className="loom-card p-5">
      <h2 className="loom-section-title">Create event</h2>
      <div className="mt-4">
        <EventForm familyId={context.activeFamilyId} members={members} endpoint="/api/events" method="POST" submitLabel="Create event" redirectTo="/calendar" />
      </div>
    </section>
  );
}
